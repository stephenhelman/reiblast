...
export const metadata: Metadata = {
  ...
  description:
    "Built by a wholesaler, for wholesalers. Meet Ari and the story behind REIblast.",
};
    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="py-16 px-6">
        <div className="max-w-2xl mx-auto" style={{ maxWidth: 680 }}>
          ...
          <p className="text-white/70 text-lg leading-[1.85] mb-6">
            The problem was the tools. Every part of the process lived in a
            different app. DealMachine for lists. BatchLeads for skip tracing. A
            random CRM for contacts. ChatGPT for cleaning data. A separate
