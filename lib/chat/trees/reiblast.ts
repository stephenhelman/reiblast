import { TEXT_RATE, DAILY_CAP_SOLE, DAILY_CAP_LLC, RAMP_RUNGS } from '@/lib/marketingPricing';
 ...
 * Ladder cost lines are computed from lib/marketingPricing.ts's TEXT_RATE — never
