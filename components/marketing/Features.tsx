...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      "Battle-tested follow-up sequences pre-loaded. Start texting your list same day.",
  },
  {
    icon: "📄",
    title: "Universal Wholesale Contract",
    description:
      "Jurisdiction-ready purchase and sale agreement. Just fill and send.",
  },
  {
    icon: "✍️",
    title: "E-Sign Built In",
    description:
      "Send contracts for signature without leaving your dashboard. Close faster.",
  },
  {
    icon: "🧮",
    title: "Deal Analyzer (BETA)",
    description:
      "Instant MAO calculation and deal scoring so you never overpay for a deal.",
  },
  {
    icon: "🤝",
    title: "JV Deal Submission",
    description:
      "Got a deal but need a buyer? Submit JV opportunities directly to the network.",
  },
];
